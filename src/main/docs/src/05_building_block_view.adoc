...
Foundry-VTT:
Some SCS have defined a FoundryVTT API. This API is not defined yet.
Target is to offer https://foundryvtt.com[FoundryVTT] modules to integrate with DCIS to enable the gameplay and make it as easy as possible to players to play Torg Eternity.
