...
include::architecture/modules/arc42/pages/03_system_scope_and_context.adoc[leveloffset=+1]
...
<<<
// 6. Runtime View
include::architecture/modules/arc42/pages/06_runtime_view.adoc[leveloffset=+1]
