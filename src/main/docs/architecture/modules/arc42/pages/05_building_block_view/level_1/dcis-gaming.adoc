...
It relies on data provided by xref:arc42:05_building_block_view/level_1/dcis-operatives.adoc[] and xref:arc42:05_building_block_view/level_1/dcis-users.adoc[].
