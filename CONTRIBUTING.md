# Contributing to torganized-play-architecture

You want to contribute to torganized-play-architecture? Welcome! Please read this document to understand what you can do:
...
You can help torganized-play-architecture by helping others who use it and need support.

## Analyze Issues

Analyzing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/Paladins-Inn/torganized-play-architecture/issues?state=open) and find an open issue which needs additional work or a bugfix (e.g. issues labeled with "help wanted" or "bug").
...
If you find a bug - behavior of torganized-play-architecture code contradicting your expectation - you are welcome to report it.
We can only handle well-reported, actual bugs, so please follow the guidelines below.

Once you have familiarized with the guidelines, you can go to the [GitHub issue tracker for torganized-play-architecture](https://github.com/Paladins-Inn/torganized-play-architecture/issues/new) to report the issue.
...
We want to improve the quality of torganized-play-architecture and good bug reports are welcome! But our capacity is limited, thus we reserve the right to close or to not process insufficient bug reports in favor of those which are very cleanly documented and easy to reproduce. Even though we would like to solve each well-documented issue, there is always the chance that it will not happen - remember: torganized-play-architecture is Open Source and comes without warranty.

Bug report analysis support is very welcome! (e.g. pre-analysis or proposing solutions)

## Contribute Code

You are welcome to contribute code to torganized-play-architecture in order to fix bugs or to implement new features.
...
3. **Not all proposed contributions can be accepted**.
   ...
   The code must fit the overall direction of torganized-play-architecture and really improve it.
...
When you contribute (code, documentation, or anything else), you have to be aware that your contribution is covered by the same [LGPL 3.0](https://www.gnu.org/licenses/lgpl-3.0.txt) that is applied to torganized-play-architecture itself.
...
A company representative authorized to do so needs to download, fill, and print the [Corporate Contributor License Agreement](https://github.com/Paladins-Inn/torganized-play-architecture/blob/master/KES%20Corporate%20Contributor%20License%20Agreement%20(2019-12-31).pdf)
form.
Then either:
...
7. Follow the link posted by the torganized-play-architecture to your pull request and accept it, as described in detail above.
8. Wait for our code review and approval, possibly enhancing your change on request
   * Note that the torganized-play-architecture developers also have their regular duties, so depending on the required effort for reviewing, testing and clarification this may take a while
